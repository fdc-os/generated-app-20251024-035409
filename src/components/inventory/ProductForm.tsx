...
const productSchema = z.object({
  ...
  stock: z.object({
    full: z.coerce.number().int().min(0, 'Stock cannot be negative.').optional(),
    empty: z.coerce.number().int().min(0, 'Stock cannot be negative.').optional(),
    defective: z.coerce.number().int().min(0, 'Stock cannot be negative.').optional(),
  }),
});
